...
\subsection{R.XYZ.CLOUDSTORAGE.FILE.002 文件：查看文件属性}
...
\subsection{R.XYZ.CLOUDSTORAGE.FILE.003 文件：排序显示}
...
\subsection{R.XYZ.CLOUDSTORAGE.FILE.004 文件：重命名}
...
\subsection{R.XYZ.CLOUDSTORAGE.FILE.005 文件：复制、粘贴、剪切}
...
\subsection{R.XYZ.CLOUDSTORAGE.FILE.006 文件：收藏夹}
